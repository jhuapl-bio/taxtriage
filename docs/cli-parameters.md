...
| `--db_cache_dir <path\|s3://...>`          | auto                 | Base directory for **every** auto-downloaded db cache (`<base>/mmseqs`, `<base>/kaiju`, `<base>/kraken2`). Unset, the pipeline uses `${projectDir}/dbs` for a local checkout and `${workDir}/dbs` when the pipeline was pulled or the work dir is a bucket (Seqera/cloud) — see [Database caching on Seqera / cloud](novelty-detection.md#database-caching-on-seqera--cloud).                                                                                       |
| `--novelty_db_cache <path>`                | auto                 | `storeDir` cache for the mmseqs2 download. Overrides `--db_cache_dir`.                                                                                                                                                                                                                                                                                                                                                                                              |
| `--novelty_db_prefix <str>`                | `seqTaxDB`           | Base name of the mmseqs2 database files inside the db directory.                                                                                                                                                                                                                                                                                                                                                                                                    |
| `--novelty_kaiju_db_cache <path>`          | auto                 | `storeDir` cache for the kaiju download. Overrides `--db_cache_dir`.                                                                                                                                                                                                                                                                                                                                                                                                |
| `--novelty_kraken2_db_cache <path>`        | auto                 | `storeDir` cache for the bracken/kraken2 download. Overrides `--db_cache_dir`.                                                                                                                                                                                                                                                                                                                                                                                      |

...
| `--sensitive`                                         | Sensitive mode for confidence metrics. This will use version 3 of the TASS Score calculator which implements per-genome comparison signatures.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| `--skip_matrix`                                       | Skips ANI similarity matching for the final report. Improves compute time.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| `--conf_sens`                                         | Sensitive mode for confidence metrics. Uses all BAM query alignments rather than the reference from the alignment. Considered I/O intensive and much slower. Useful if there are a lot of variants present in the alignments, otherwise keep disabled                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| `--sorttass <boolean>`                                | In the Final PDF, the tables sort on High Consequence THEN TASS score. Enabling this will only sort on TASS.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| `--genome`                                            | Pull one of the pre-made igenomes databases for host removal. Available list at [here](https://github.com/jhuapl-bio/taxtriage/blob/main/conf/igenomes.config#L11) (aws cli or curl command) to download them locally. Use the Key value such as: GRCh37, BDGP6, GRCz10, etc.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `--remove_reference_file`                             | Remove all reads that align to a set of accessions in a single fasta file                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `--both_unmapped`                                     | For paired end reads, require that BOTH reads to be unmapped when extracting non-host reads. Otherwise, extracts only reads that map regardless of pairing. Ignored if single end.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `--split_prefix`                                      | When using minimap2, specify you want to `split-prefix` to reduce RAM requirements but increase alignment time. Useful for local systems with limited resources, especially when aligning to either the human genome or the full pathogens.fasta file provided in the repo.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |

...
| `--split-prefix`                             | When using minimap2, specify you want to split-prefix to reduce RAM requirements but increase alignment time. Useful for local systems with limited resources, especially when aligning to either the human genome or the full pathogens.fasta file provided in the repo.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |

...
| `--ani_removal`                                       | Compare, not only the shared signatures across aligned regions, but also whole assembly sequences from the original fasta file(s). Introduces a more aggressive method of removing potential multi-mapped or false-positively mapped reads.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |

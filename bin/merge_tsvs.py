...
parser.add_argument('--header', '-d',  action='store_true', default=True,  help='If header is present, extract first row first file, ignore for rest')
parser.add_argument('--output', '-o', type=str, required=True, help='Output TSV file that is merged')
parser.add_argument('--append_name', '-a', action='store_true', default=False,  help='Append the basename of the file as the first column')
# Parse the arguments

...
parser.add_argument('--input', '-i', type=str, required=True, help='Input kraken report file')
parser.add_argument('--output', '-o', type=str, required=True, help='Output TSV file')
parser.add_argument('--id', '-d', type=str, default="N/A", required=False, help='Sample id of the sample')
# Parse the arguments

process DIAMOND_BLASTX {
    ...
    def outfmt
    if      ( out_ext == "blast" ) { outfmt = 0   }
    else if ( out_ext == "xml"   ) { outfmt = 5   }
    else if ( out_ext == "txt"   ) { outfmt = 6   }
    else if ( out_ext == "daa"   ) { outfmt = 100 }
    else if ( out_ext == "sam"   ) { outfmt = 101 }
    else if ( out_ext == "tsv"   ) { outfmt = 102 }
    else if ( out_ext == "paf"   ) { outfmt = 103 }
    else {
        outfmt  = 6
        out_ext = 'txt'

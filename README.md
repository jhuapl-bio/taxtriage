...
[![Docs](https://img.shields.io/badge/docs-documentation-red)](https://jhuapl-bio.github.io/taxtriage/latest/)
[![Interactive report](https://img.shields.io/badge/live-interactive%20report-red)](https://jhuapl-bio.github.io/taxtriage/latest/demo-report/)
...
[**Open the interactive report demonstration**](https://jhuapl-bio.github.io/taxtriage/latest/demo-report/) · [**Read the TASS scoring documentation**](https://jhuapl-bio.github.io/taxtriage/latest/tass-scoring/) · [**Browse the full documentation**](https://jhuapl-bio.github.io/taxtriage/latest/)
...
TASS is not a renamed Kraken2 confidence value or a single coverage cutoff. It is a post-alignment synthesis of multiple evidence types with configurable weights, transformations, and thresholds. The equations, default weights, conflict-resolution logic, and optimization approach are documented in the [TASS scoring documentation](https://jhuapl-bio.github.io/taxtriage/latest/tass-scoring/).
...
See the [documentation site](https://jhuapl-bio.github.io/taxtriage/latest/) for samplesheet preparation, database setup, cloud execution, offline operation, and the complete parameter reference.
...
For current options, use the [CLI parameter reference](https://jhuapl-bio.github.io/taxtriage/latest/cli-parameters/).
...
The interactive report can be built for offline viewing. See the [Interactive Report documentation](https://jhuapl-bio.github.io/taxtriage/latest/interactive-report/) for `--offline_report` and `--offline_report_files`.
...
See [Output](https://jhuapl-bio.github.io/taxtriage/latest/output/) for exact locations and file naming.
...
- [Installation](https://jhuapl-bio.github.io/taxtriage/latest/installation/)
- [Running the pipeline](https://jhuapl-bio.github.io/taxtriage/latest/running-the-pipeline/)
- [Samplesheet and metadata](https://jhuapl-bio.github.io/taxtriage/latest/samplesheet/)
...
- [Pathogen annotation sheet](https://jhuapl-bio.github.io/taxtriage/latest/pathogen-sheet/) — searchable, filterable table of every annotated organism
- [Interactive report demo](https://jhuapl-bio.github.io/taxtriage/latest/demo-report/) — live example report
